...
for col in num_cols:
    print(col, check_outlier(df, col))      # --> burada check outlier gibi olan fonksiyonlar eklenecek
...
# yeni oluşan veriler bizim için kıymetli bir bilgi taşıyor mu diye soralım:
cat_cols, num_cols, cat_but_car = grab_col_names(df)
